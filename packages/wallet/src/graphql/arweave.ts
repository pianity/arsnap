...
export type GetCurrentHeightQuery = {
    __typename?: "Query";
...
export type TransactionFragment = {
    ...
    edges: Array<{
        ...
        node: {
            ...
            quantity: { __typename?: "Amount"; ar: string };
            fee: { __typename?: "Amount"; ar: string };
            block?: { __typename?: "Block"; timestamp: number } | null;
        };
    }>;
};
...
export type IncomingTransactionsQuery = {
    __typename?: "Query";
    transactions: {
        __typename?: "TransactionConnection";
        edges: Array<{
...
export type OutgoingTransactionsQuery = {
    __typename?: "Query";
    transactions: {
        __typename?: "TransactionConnection";
        edges: Array<{
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        getCurrentHeight(
            variables?: GetCurrentHeightQueryVariables,
            requestHeaders?: Dom.RequestInit["headers"],
        ): Promise<GetCurrentHeightQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetCurrentHeightQuery>(GetCurrentHeightDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                "getCurrentHeight",
        ...
        incomingTransactions(
            variables: IncomingTransactionsQueryVariables,
            requestHeaders?: Dom.RequestInit["headers"],
        ): Promise<IncomingTransactionsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<IncomingTransactionsQuery>(
                        IncomingTransactionsDocument,
                        variables,
        ...
        outgoingTransactions(
            variables: OutgoingTransactionsQueryVariables,
            requestHeaders?: Dom.RequestInit["headers"],
        ): Promise<OutgoingTransactionsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<OutgoingTransactionsQuery>(
                        OutgoingTransactionsDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders },
                    ),
                "outgoingTransactions",
